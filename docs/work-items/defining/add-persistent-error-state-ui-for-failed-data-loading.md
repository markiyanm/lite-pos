...
description: All pages use onMount with try/catch that shows a brief toast on failure,
  but continue to render with empty data. No persistent error indicator is shown.
  If the DB is unreachable, users see an empty app with a disappearing toast. Add
  error state variables and fallback UI on each page.
status: defining
pipeline: frontend
priority: P2
tags:
...
updated_at: '2026-03-22T03:58:34Z'
rework_count: 0
artifacts:
  research: []
  design: []
...
- status: queued
  ...
  exited: '2026-03-22T03:58:34Z'
- status: defining
  entered: '2026-03-22T03:58:34Z'
---
